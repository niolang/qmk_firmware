 ...
 */
 ...
 [_BEPO] = LAYOUT(
  ...
  KC_LSFT,             BP_AGRV, BP_Y,    BP_X,  BP_DOT,    BP_K, KC_GRV, KC_DEL,  BP_QUOT,  BP_Q,    BP_G,    BP_H,    BP_F,    KC_RSFT,
 ...
 */
  [_ADJUST] = LAYOUT(
  BP_DLR, BP_DEG, BP_GRV, BP_CIRC, BP_PLMN, BP_NEQL,                   KC_SCRL, KC_INS,  KC_PAUSE, XXXXXXX, XXXXXXX, XXXXXXX,
  BP_NDSH, BP_MDSH, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   KC_NUM,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   KC_CALC, XXXXXXX, XXXXXXX, KC_MSTP, KC_MNXT, KC_VOLU,
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_MPLY, KC_MPRV, KC_VOLD,
                             _______, _______, _______, _______, _______,  _______, _______, _______
  )
};
